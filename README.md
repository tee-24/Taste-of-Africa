...
| Shopping bag                        | Click on the bag icon at the top right                                                                                                   | Redirect to 'shopping bag' page                                                                                                                                                           | Pass      |
| Update link (shopping bag)          | Update item quantity<br>Click update                                                                                                     | Price total and product quantity is updated                                                                                                                                               | Pass      |
| Remove link (shopping bag)          | Click remove                                                                                                                             | Price total and product quantity is updated                                                                                                                                               | Pass      |
| Keep shopping button (shopping bag) | Click keep shopping                                                                                                                      | Redirect to 'Mains' page                                                                                                                                                                  | Pass      |
